...
const TeamMemberCard = ({employee, handleEmployeeCardClick, selectedTeam}) => {
  ...
  onClick={handleEmployeeCardClick}>
              { (employee.gender === 'male') ?<img src={maleProfile} className='card-img-top'width="18rem" alt='malepic'/> :
                <img src={femaleProfile} className='card-img-top'width="18rem" alt='femalepic'/>
              }
